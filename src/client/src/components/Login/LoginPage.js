...
import QrCode from '../../images/project-tracker.png';
    ...
    return (
        <div>
            ...
            <div className='rowB' style={!login ? { marginTop: 10 } : {}}>
                <h2 className='LRTitle'>{login ? 'Login' : 'Register'}</h2>
                {login ?
                    <form onSubmit={handleSubmit(userLogin)}>
                        ...
                        <div className="form-control">
                            <button className='LRBtn' type="submit" disabled={Object.keys(errors).length > 0}>Login</button>
                        </div>
                    </form>
                    :
